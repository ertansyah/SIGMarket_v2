<div class="col-md-12">
    <div class="card card-outline card-success">
        ...
        <div class="card-body">
            ...
            ?>
            <?php echo form_open_multipart('Wilayah/UpdateData/'.$wilayah['id_wilayah'], ['id' => 'edit-form']) ?>
            <div class="row">
                <div class="col-sm-6">
            ...
            <div class="form-group">
               <label for="geojson_file" class="form-label" style="font-weight: bold; font-size: 1.2em; color: #333;">Update File GeoJSON</label>
    ...
    <small class="form-text text-muted mt-2">Pilih file dengan format .geojson untuk diunggah.</small>
                <br>
                <textarea name="geojson" id="geojson_textarea" class="form-control" rows="15"><?= $wilayah['geojson'] ?></textarea>
